...
The complete and runnable source code explained in this chapter, together with all 26 notebooks and this report, is publicly available in the project repository at \url{https://github.com/bennyy117/adaptive_salmonella}. The listings below are excerpts from that repository, edited only for presentation.
