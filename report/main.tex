...
\def \TITLE{Antibiotic-aware Adaptive Feature Fusion for Salmonella Antimicrobial Resistance Prediction}
\def \AUTHOR{Nguyen Bich Loan}
...
\newpage
\chapter{PROPOSED ARCHITECTURE AND PIPELINE}\label{ch:arch}
\subfile{Chapter/A_architecture}

\newpage
\chapter{IMPLEMENTATION AND SOURCE CODE}\label{ch:impl}
\subfile{Chapter/B_implementation}

\newpage
\chapter{THEORETICAL ANALYSIS}\label{ch:theory}
